...
<ul class="grid cs-style l jcarousel-skin-ie7" id="movie">
	...
	<li>
		<figure>
			<div><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/content/13.jpg" alt="img13"></div>
			<figcaption>
				<h3>Transformers</h3>
	...
	<li>
		<figure>
			<div><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/content/14.jpg" alt="img14"></div>
			<figcaption>
				<h3>Real Steel</h3>
	...
	<li>
		<figure>
			<div><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/content/15.jpg" alt="img15"></div>
			<figcaption>
	...
	<li>
		<figure>
			<div><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/content/16.jpg" alt="img16"></div>
			<figcaption>
				<h3>Hunger Games</h3>
				<span>Cras nec erat lacus. Nam quam nisl, elementum nec consequat sit amet, venenatis consequat turpis. Nunc venenatis tellus vel tempus condimentum. Nam sodales magna vel nulla blandit, ut sodales turpis auctor. Ut consectetur nisl dolor, non facilisis neque vulputate nec.</span>
				<a href="#">Watch</a>
	...
	<li>
		<figure>
			<div><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/content/17.jpg" alt="img017"></div>
			<figcaption>
				<h3>The Hobbit</h3>
				<span>Ut purus risus, consectetur quis fringilla a, mattis aliquam ligula. Donec sed mauris vel velit gravida porttitor. Etiam cursus id nunc et adipiscing. Cras a nulla a lectus semper scelerisque non et dolor. Nullam at elit a erat hendrerit auctor. Ut mi metus, venenatis porttitor quam in.</span>
				<a href="#">Watch</a>
	...
	<li>
		<figure>
			<div><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/content/18.jpg" alt="img18"></div>
			<figcaption>
				<h3>Abduction</h3>
				<span>Ut purus risus, consectetur quis fringilla a, mattis aliquam ligula. Donec sed mauris vel velit gravida porttitor. Etiam cursus id nunc et adipiscing. Cras a nulla a lectus semper scelerisque non et dolor. Nullam at elit a erat hendrerit auctor. Ut mi metus, venenatis porttitor quam in.</span>
				<a href="#">Watch</a>
