...
class Products extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('parent_id, type_product_id', 'safe'),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('id, name, zte_product_code, price, parent_id, type_product_id', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function relations() {
        ...
        return array(
            'typeProduct' => array(self::BELONGS_TO, 'TypeProduct', 'type_product_id'),
    ...
    public function search() {
        ...
        $criteria->compare('type_product_id', $this->type_product_id);
